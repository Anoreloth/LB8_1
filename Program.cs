...
namespace LB8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Create(pd);
            Copy(pd + "\\Texts", pd + "\\Sukmaniuk");
            Copy(pd + "\\Sources", pd + "\\Sukmaniuk");
            Copy(pd + "\\Reports", pd + "\\Sukmaniuk");
            Console.WriteLine("Каталоги успiшно скопiйованi");
            Move(pd + "\\Sukmaniuk", pd + "\\KN1-B20" + "\\Sukmaniuk");
            ...
            void Create(string path)
            {
                ...
                Directory.CreateDirectory(path + "\\KN1-B20" + "\\Sukmaniuk");
                Directory.CreateDirectory(path + "\\Sukmaniuk");
